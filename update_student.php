<?php
  ...
  if(isset($_POST['submit'])){
    ...
    //$pattern = "/^[0-1]$/";
    $update = $_POST['updated_value'];
    $upd = "UPDATE `sms_student_data` SET `student_status_id`='$update' WHERE id='$id'";
    ...
    if($matched==true){
      ...
      $upd = "UPDATE `student_data` SET `student_status_id`='$update' WHERE id='$id'";
       mysqli_query($conn,$upd);
      ...
      header("LOCATION:student_status_update.php");
    }else{
