...
<!--HEADER BEGINS-->
  ...
  <div class="card-header text-right">
    <div class="text-left d-inline text-info"><h3>Update results</h3></div>
...
$id = $_GET['e_id'];
//echo $id;
$select6 = "SELECT * FROM sms_result WHERE id='$id'";
...
<!--Body begins-->
  <div class="card-body text-left">
    <form method="post" action="addresult_update.php" onsubmit="return valid()">
          <h3 class="text-success font-weight-bold">Edit marks of <?php echo $result['student_name']?> </h3>
          <div class="form-group">
            ...
            <select class="form-control" name="student_id" id="stu">
              ...
              ?>
              <option value="<?php echo $res['id'];?>" <?php if($result['student_name']==$res['name']){echo 'selected';}?>>
         ...
         <table class="table">
            ...
            <tbody>
              <tr>
                ...
                <td><input type="number" name="gainedmarks1" id="gainedmarks1" value="<?php echo $result['sub1marks'];?>"><br><span id="error1" class="text-danger font-weight-bold"></span></td>

              </tr>
              <tr>
                <td><?php echo $res2['subject2'];?></td>
                <td id="totalmarks2"><?php echo $res2['marks2'];?></td>
                <td><input type="number" name="gainedmarks2" id="gainedmarks2" value="<?php echo $result['sub2marks'];?>"><br><span id="error2" class="text-danger font-weight-bold"></span></td>
              </tr>
              <tr>
                <td><?php echo $res2['subject3'];?></td>
                <td id="totalmarks3"><?php echo $res2['marks3'];?></td>
                <td><input type="number" name="gainedmarks3" id="gainedmarks3" value="<?php echo $result['sub3marks'];?>"><br><span id="error3" class="text-danger font-weight-bold"></span></td>
              </tr>
              <tr>
                <td><?php echo $res2['subject4'];?></td>
                <td id="totalmarks4"><?php echo $res2['marks4'];?></td>
                <td><input type="number" name="gainedmarks4" id="gainedmarks4" value="<?php echo $result['sub4marks'];?>"><br><span id="error4" class="text-danger font-weight-bold"></span></td>
              </tr>
            </tbody>
          </table>
          <input type="submit" name="add_result" class="btn btn-success" value="Update">
