 <!-- Sidebar -->
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="teacher_view_student.php">
          <!--i class="fas fa-fw fa-tachometer-alt"></i-->
          <span>Student</span></a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="teacher_upload_result.php">
          <!--i class="fas fa-fw fa-tachometer-alt"></i-->
          <span>Result</span></a>
      </li>
      <hr class="sidebar-divider">
     <li class="nav-item active">
        <a class="nav-link" href="teacher_upload_pic.php">
          <!--i class="fas fa-fw fa-tachometer-alt"></i-->
          <span>Upload profile pic</span></a>
      </li>
      ...
      <!--li class="nav-item"-->
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="viewproduct.php">View</a>
          </div>
        </div>
      </li-->
