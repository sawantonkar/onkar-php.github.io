...
*/
  ...
  <div class="container-fluid">
    ...
    <h5 class="text-danger">Deactive => Deny access</h5><br><h5 class="text-success">Active => Grant access</h5>
    <br><br><br>
      <form action="update_teacher.php" method="POST">
          <!--div class="form-group">
            <label for="formGroupExampleInput">Enter value here:</label><br>
            <input type="text"  id="formGroupExampleInput" name="updated_value" value="<?php //echo $res['teacher_status_id'];?>">
            </div-->

            <div class="form-group">
              <label for="exampleFormControlSelect1">Update status:</label>
              <select class="" id="exampleFormControlSelect1" name="updated_value">
                <option value="Deactive"<?php if($res['teacher_status_id']=='Deactive'){echo 'selected';}?>>Deactive</option>
                <option value="Active"<?php if($res['teacher_status_id']=='Active'){echo 'selected';}?>>Active</option>
